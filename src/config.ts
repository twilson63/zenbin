...
export const config = {
  ...
  get stripe() {
    return {
      ...
      proPriceId: process.env.STRIPE_PRO_PRICE_ID || 'price_1TUXnMCdTeU3dtdYYpicTmck',
      enterprisePriceId: process.env.STRIPE_ENTERPRISE_PRICE_ID || 'price_1TUXnvCdTeU3dtdYyNgZUcOn',
